...
const records: TestRecord[] = [
  ...
  // 站点 A - v1.0.0 - session A-2: 不通过
  { sessionId: 'A-2', stationId: 'A', stationName: '站点 A', version: 'v1.0.0', testType: '进站', result: '失败', issueCategory: '定位异常', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.0.0', testDate: '2026-07-01' },
  { sessionId: 'A-2', stationId: 'A', stationName: '站点 A', version: 'v1.0.0', testType: '停泊', result: '失败', issueCategory: '定位异常', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.0.0', testDate: '2026-07-01' },
  { sessionId: 'A-2', stationId: 'A', stationName: '站点 A', version: 'v1.0.0', testType: '出站', result: '通过', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.0.0', testDate: '2026-07-01' },
  // 站点 A - v1.1.0 - session A-3: 通过
  { sessionId: 'A-3', stationId: 'A', stationName: '站点 A', version: 'v1.1.0', testType: '进站', result: '通过', singleResult: 'OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  { sessionId: 'A-3', stationId: 'A', stationName: '站点 A', version: 'v1.1.0', testType: '停泊', result: '通过', singleResult: 'OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  { sessionId: 'A-3', stationId: 'A', stationName: '站点 A', version: 'v1.1.0', testType: '出站', result: '通过', singleResult: 'OK', stationConclusion: '通过', vin: 'VIN001', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  ...
  { sessionId: 'B-2', stationId: 'B', stationName: '站点 B', version: 'v1.1.0', testType: '出站', result: '通过', singleResult: 'OK', stationConclusion: '通过', vin: 'VIN002', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  // 站点 B - v1.1.0 - session B-3: 不通过
  { sessionId: 'B-3', stationId: 'B', stationName: '站点 B', version: 'v1.1.0', testType: '进站', result: '通过', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN002', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  { sessionId: 'B-3', stationId: 'B', stationName: '站点 B', version: 'v1.1.0', testType: '停泊', result: '通过', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN002', adVersion: 'v1.1.0', testDate: '2026-07-02' },
  { sessionId: 'B-3', stationId: 'B', stationName: '站点 B', version: 'v1.1.0', testType: '出站', result: '失败', issueCategory: '感知漏检', singleResult: 'NO OK', stationConclusion: '通过', vin: 'VIN002', adVersion: 'v1.1.0', testDate: '2026-07-02' },
];
...
describe('calculateReport', () => {
  ...
  it('counts stations and versions', () => {
    ...
    expect(report.completedStations).toBe(2);
